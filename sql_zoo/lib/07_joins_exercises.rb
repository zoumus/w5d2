...
def andrews_films_and_leads
  ...
  WHERE
    ...
    -- all the movies that Julie Andrews is in
    SELECT
      title
    FROM
      movies
...
def colleagues_of_garfunkel
  ...
  # subquery = find all of the movies 'Art Garfunkel' played in
  # find all of the actors in those movies who are not 'Art Garfunkel'
  execute(<<-SQL)
  SELECT
    actors.name
  FROM 
